            ...
            <CardContent className="flex flex-col items-center px-0">
              ...
              <div className="mt-[var(--frida-space-large)] flex w-full flex-col items-stretch gap-[var(--frida-space-medium)] sm:w-auto sm:flex-row sm:items-center">
                ...
                <Link href="/login" className="sm:min-w-48">
                  <Button
                    variant="outline"
                    className="h-11 w-full gap-[var(--frida-space-small)] rounded-[var(--frida-radius-default)] border-[var(--frida-primary)] px-[var(--frida-space-large)] text-[var(--frida-primary)] hover:bg-[var(--frida-gray-primary)] hover:text-[var(--frida-brand-hover)]"
                  >
        ...
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-[var(--frida-space-large)] flex flex-col items-stretch gap-[var(--frida-space-medium)] sm:flex-row sm:justify-center">
            ...
            <Link href="/login" className="sm:min-w-48">
              <Button
                variant="outline"
                className="h-11 w-full gap-[var(--frida-space-small)] rounded-[var(--frida-radius-default)] border-[var(--frida-surface)] px-[var(--frida-space-large)] text-[var(--frida-surface)] hover:bg-[var(--frida-surface)] hover:text-[var(--frida-primary)]"
              >
                <LogInIcon className="size-5" />
                Anmelden
              </Button>
